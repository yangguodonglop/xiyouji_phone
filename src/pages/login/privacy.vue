    ...
    <div class="xy_con_text">
        ...
        <div class="privacy">
            ...
            <div class="privacy_con">
                ...
                <p>1.2除本协议约定的除外情况，西柚APP保证不对外公开或向第三方提供、公开或共享您的个人数据及隐私信息。</p>

                <p>1.3 在以下情况下，西柚APP对您个人数据及隐私信息的披露将不视为违约，具体包括：</p>
