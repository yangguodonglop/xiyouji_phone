...
<div class="container">
    ...
    <headers></headers>
    <div class="xiala">
        <scroller style="height: 100%;" :on-refresh="refreshs" :on-infinite="infinite" ref="myscroller" class="scroller">
            <!-- 网络异常 -->
            ...
            <img src="../../assets/images/paihangbang.png" alt>排行榜
                ...
                <div class="ranking_con" v-for="(item,index) in minerInfo" v-bind:key="index">
                    <div class="ranking_con_item" v-bind:sn="item.dev_sn">
                        <div class="con_item_l">
                            <div class="item_l_top">
                                <div class="item_l_name">{{item.dev_name}}</div>
                                <div class="new_active">
                                    <!-- <div class="dot" v-if="item.dev_online_state=='在线'"></div>
                                    <div class="dot1" v-else></div> -->
