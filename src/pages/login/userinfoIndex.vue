    ...
    <div class="user_nav">
        <div class="user_nav_t user_nav_t_active">
            <div class="item_title">
                <p> <img src="../../assets/images/userinfo_03.png" alt="">积分</p>
            </div>
        ...
        <div class="user_nav_t user_nav_t_active1">
            <div class="item_title item_title_active">
                <p class="active_p"> <img src="../../assets/images/userinfo_04.png" alt="" class="active_img">设备</p>
            </div>
            <div class="item_con">
                <div class="item">
                    <p class="p1" @click="goLink1()">设备总数</p>
                    <p class="p2 active">{{line_total}}</p>

                </div>
                <div class="item">
                    <p class="p1" @click="goLink1()">在线设备</p>
