...
<div class="user_head">
    ...
    <van-popup v-model="show" position="left" class="my_popup">
        ...
        <div class="nav_list">
            <div class="item" @click="goLink('userinfoIndex')"> <img src="../assets/images/pandect_icon.png">总览</div>
            <div class="item" @click="goLink('managementnew')"> <img src="../assets/images/usercenter_01.png">设备明细</div>
            <div class="item" @click="goLink('bill')"> <img src="../assets/images/usercenter_02.png">积分明细</div>
            <div class="item" @click="goLinkout()"> <img src="../assets/images/usercenter_03.png">退出登录</div>
